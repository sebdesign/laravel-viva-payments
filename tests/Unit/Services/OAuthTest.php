...
class OAuthTest extends TestCase
{
    ...
    public function it_requests_an_access_token_with_the_default_credentials(): void
    {
        ...
        self::assertHeader('Authorization', 'Basic '.base64_encode('client_id:client_secret'), $request);
        self::assertBody('grant_type', 'client_credentials', $request);

        self::assertEquals('eyJhbGciOiJSUzI1NiIsImtpZCI6IjBEOEZCOEQ2RURFQ0Y1Qzk3RUY1MjdDMDYxNkJCMjMzM0FCNjVGOUYiLCJ0eXAiOiJKV1QiLCJ4NXQiOiJEWS00MXUzczljbC05U2ZBWVd1eU16cTJYNTgifQ..GNjeRJhQQir3M_rqvjC0C9Up_pA2AFxlv9dhpr-7C-Lk0Xr5gJyGwgb0BD7Bvp2Oku-CjgG8tqE0s8KaWGHYIqGQyFJIUWiHWMejRKRqkuzt128NbThX7f4w-tN6DoyP1EouDhBsMs5BwrxOkbkIXtSjBxkE7jEOrRJ4YNAv-DjuDsPtAjC0cTLEDQBnMHLHAE-c2XHJ84I9WLFnOUX6-lwdwWuefv5o6BpvfNFC6y0mR-DcAi9KE82jRFVoY5G7xY6HQnS6RqaNDC5ifhdZKZcpgUxxdPTIWpS5L2F81RXsoMq3BSAWqvwuNeT8QTWDvtAsv_fgUABs06P7-slnvg', $token->access_token);
        self::assertEquals(3600, $token->expires_in);
        self::assertEquals('Bearer', $token->token_type);
        self::assertEquals('urn:viva:payments:core:api:test', $token->scope);
    }
